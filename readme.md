...
<div class="info-block">
  ...
  <p>Тема: <strong>Анализ влияния системы течений (океан-атмосфера) на расчёт температуры воздуха</strong></p>
</div>
...
<div class="topic-block">
  <p>направление подготовки 01.03.02 «Прикладная математика и информатика»</p>
  <p>направленность (профиль) «Технологии программирования и анализ данных»</p>
  <p style="margin-top: 18pt;">Тема: <strong>Анализ влияния системы течений (океан-атмосфера) на расчёт температуры воздуха</strong></p>
</div>
